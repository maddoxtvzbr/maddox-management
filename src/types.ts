...
// "cancelado" preserva o histórico e os dados financeiros já lançados, mas
// sai da Agenda e deixa de contar nos totais do Financeiro — sem apagar nada.
export type EventoStatus = "confirmado" | "cancelado";
